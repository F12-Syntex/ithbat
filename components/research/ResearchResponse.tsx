    ...
    >
      ...
      {isStreaming && (
        <div className="flex items-center gap-1.5 mb-3">
          ...
          />
          <span className="text-[10px] text-emerald-500 font-medium">Writing response...</span>
        </div>
      )}
      ...
      <article
        className="prose prose-base dark:prose-invert max-w-none
          ...
          prose-blockquote:border-l-3 prose-blockquote:border-emerald-500 prose-blockquote:bg-emerald-50/50 dark:prose-blockquote:bg-emerald-900/20 prose-blockquote:py-2 prose-blockquote:px-4 prose-blockquote:rounded-r-lg prose-blockquote:not-italic prose-blockquote:text-sm sm:prose-blockquote:text-base prose-blockquote:text-neutral-700 dark:prose-blockquote:text-neutral-300
          prose-code:text-emerald-600 dark:prose-code:text-emerald-400 prose-code:bg-emerald-50 dark:prose-code:bg-emerald-900/30 prose-code:px-1.5 prose-code:py-0.5 prose-code:rounded prose-code:text-sm prose-code:before:content-none prose-code:after:content-none"
      >
        <ReactMarkdown
          components={{
            a: ({ href, children }) => (
